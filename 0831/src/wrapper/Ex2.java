...
public class Ex2 {
	...
	public static void main(String[] args) {
		 ...
		 * 참조 데이터타입(객체)은 Heap 공간에 실제 데이터가 저장되며,
		 * 참조변수가 해당 공간의 주소값을 저장 및 관리함
		...
		// Integer n2 = new Integer("20.5"); => 오류 발생
		
		System.out.println(n2);	// toString 생략 (아래 코드와 동일)
		System.out.println(n2.toString());
		
		// Integer 타입 변수 n2의 값을 출력하면 주소값이 아닌 실제 데이터가 출력됨
		// => toString() 메소드가 오버라이딩 되어 있으므로 저장된 실제 값을 리턴 하도록 함
		...
		System.out.println("기본데이터타입 num1 = " + num1);
		System.out.println("참조데이터타입 n1 = " + n1);
		// 오버라이딩 된 toString 이 생략되어 있기 때문에 데이터가 출력됨

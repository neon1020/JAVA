...
public class Ex5 {
	...
	public static void main(String[] args) {
		 ...
		 *   try ~ catch 블록 내에서 return 문의 사용으로 인해 메소드 수행이 종료되더라도
		 *   반드시 finally 블록의 코드를 실행한 후에 메소드가 종료된다!
	...
	public static void method() {
		...
		try {
			...
			return;	// 메소드 수행을 중단하고 호출한 곳으로 돌아감
